    ...
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 mx-9 md:mt-0 flex items-center">
                ...
                <a href="#newsletter" class="bg-pink-300 ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">
        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full text-center">
                    ...
                    <form method="POST" action="/newsletter" class="lg:flex text-sm align-items-center">
                       @csrf
